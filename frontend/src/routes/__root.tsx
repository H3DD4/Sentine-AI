...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sentinel.AI — Forvis Mazars Red Team Console" },
      {
        name: "description",
        content:
          "Internal AI-assisted validation and reporting workspace for Forvis Mazars offensive security engagements.",
      },
      { property: "og:title", content: "Sentinel.AI — Forvis Mazars Red Team Console" },
      {
        property: "og:description",
        content:
          "AI-validated findings, live analysis, and one-click pentest reports for red team engagements.",
      },
